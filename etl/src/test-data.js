...
export const response_for_abderhalden_maurice = {
    "suggestions": []
};

export const existingSchwinger = [
    {
        "id": 1,
        "firstName": "Fabio",
        "lastName": "Abächerli"
